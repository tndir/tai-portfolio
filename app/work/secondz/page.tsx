...
export default function SecondZ() {
  return (
    <>
      <Navbar />
      <main className="bg-white min-h-screen">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-12">
                <div>
                  ...
                  <p className="text-sm font-medium">SecondZ</p>
                </div>
                <div>
        ...
        <div className="px-8 max-w-7xl mx-auto flex flex-col gap-4 pb-32">
          <div className="w-full overflow-hidden rounded-2xl aspect-[16/9]">
            <img src="/Images/pramod-tiwari-f8gKP82Quh4-unsplash.jpg" alt="SecondZ" className="w-full h-full object-cover" />
          </div>
