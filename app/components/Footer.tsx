      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        {/* Large rotating text */}
            ...
            <p className="text-5xl md:text-6xl font-bold tracking-tighter leading-none flex flex-wrap items-center gap-x-3 gap-y-0 max-w-lg">
                ...
                <span className="inline-block h-[60px] overflow-hidden align-middle w-[200px] md:w-[360px] [mask-image:linear-gradient(to_bottom,transparent_0%,black_20%,black_80%,transparent_100%)]">
                <span className="flex flex-col animate-[spinWords2_6s_linear_infinite]">
                    <span className="h-[60px] flex items-center text-white">visualise</span>
                    <span className="h-[60px] flex items-center text-white">create</span>
                    <span className="h-[60px] flex items-center text-white">connect</span>
                    <span className="h-[60px] flex items-center text-white">visualise</span>
                </span>
                </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          {/* Social */}
          <div className="flex flex-col gap-2">
            <p className="text-xs uppercase tracking-widest text-white/40">Social</p>
            <div className="flex gap-4">
  
            <a    href="https://instagram.com/tn.dir"
                target="_blank"
            ...
            <a    href="https://www.linkedin.com/in/tai-nguyen-943951209/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/10 backdrop-blur-md text-white hover:-translate-y-1 transition-transform duration-200 hover:opacity-50"
            >
